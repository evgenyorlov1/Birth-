...
public class gui extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        uModel = new UpdateModel(entities);
        jTable2.setModel(uModel);
        ...
        jLabel5.setText("Різна цікава статистика");
        ...
        dModel = new DeleteModel(entities);
        jTable3.setModel(dModel);
...
// Enter    
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            entity en = new entity(tag1, tag2, String.valueOf(tag3), String.valueOf(data));
            
            tModel.addRow(en);
            //en is aftomaticaly added to uModel by tModel.addRow(en); 
            //uModel.addRow(en);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        for(int i=0; i<entities.size(); i++) {
            if(entities.get(i).getDelete()) {            
                Bend.delete(entities.get(i).getTag1(), entities.get(i).getTag2(), 
                    entities.get(i).getTag3(), entities.get(i).getDate());
                    entities.remove(i);
            }
        }
